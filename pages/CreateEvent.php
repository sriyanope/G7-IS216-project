    ...
    <html lang="en">
        ...
        <body>
            ...
            <nav class="navbg navbar navbar-expand-lg sticky-top navbar-light p-3 shadow-sm">
              ...
              <p>Need some inspiration before starting your own? <a href="JoinAnEvent.html">Join an Event!</a></p>
              <form id="CreateEventDetails">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="AboutThisEvent">
                  </div>
                  <div class="mb-3">
                    <label for="AboutThisEvent" class="form-label">About This Event</label>
                    <input type="text" class="form-control" id="AboutThisEvent">
                  ...
                  <div class="input-group mb-3">
                    <label class="form-label" for="UploadEventPicture">Upload Picture</label><br>
